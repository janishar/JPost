...
import static com.mindorks.jpost.center.JPost.channelMap;
import static com.mindorks.jpost.center.JPost.executorService;


/**
 * Created by janisharali on 22/09/16.
 */
public abstract class AbstractBroadcastCenter implements Broadcast<Channel<PriorityBlockingQueue<WeakReference<ChannelPost>>,
        ConcurrentHashMap<Integer,WeakReference<Object>>>> {

    private ReentrantLock channelStateChangerLock;

    public AbstractBroadcastCenter() {
    ...
    public <T> void broadcastAsync(T msg) throws JPostNotRunningException{
        ...
        executorService.execute(new BroadcastCenter.MsgTasKRunner<>(Channel.DEFAULT_CHANNEL_ID, msg));
    }
    ...
    public <T> void broadcastAsync(Integer channelId, T msg, Integer... subscribers) throws JPostNotRunningException{
        ...
        executorService.execute(new BroadcastCenter.MsgTasKRunner<T>(channelId, msg, subscribers));
    }
    ...
    public <V, T> void broadcastAsync(V registeredSubscriber, Integer channelId, T msg, Integer... subscribers) throws JPostNotRunningException{
        ...
        executorService.execute(new BroadcastCenter.PrivateMsgTasKRunner<>(registeredSubscriber, channelId, msg, subscribers));
    }
